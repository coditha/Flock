...
export const COMMUNITY_CARDS: CommunityCard[] = [
  ...
  // ── Educational cards (no gameplay effect) ──
  {
    ...
    educationalContent:
      'As your team maps surveillance devices across the city, a pattern emerges that is often invisible to individual residents. Surveillance technologies are disproportionately concentrated in lower-income and historically marginalized neighborhoods, revealing how monitoring is rarely distributed equally across a community.',
    effect: '',
    effectType: 'none',
    isPowerUp: false,
  },
  {
    ...
    educationalContent:
      'While organizing within your homeowners association, residents develop a shared set of expectations regarding surveillance use. The resulting community agreement establishes privacy standards that make it politically and socially costly for officials to ignore resident concerns.',
    effect: '',
    effectType: 'none',
    isPowerUp: false,
  },
  {
    ...
    educationalContent:
      'Rather than relying on surveillance technologies, neighbors organize regular safety walks and mutual support networks to address community concerns through relationship-building and collective presence.',
    effect: '',
    effectType: 'none',
    isPowerUp: false,
  },
  {
    ...
    type: 'community',
    category: 'purple',
    name: 'Local Art Awareness',
    educationalContent:
      'Local artists create murals, public installations, and community art projects that spark conversations about privacy, surveillance, and public space. The artwork encourages residents to reflect on how monitoring shapes everyday life.',
    effect: '',
    effectType: 'none',
    isPowerUp: false,
  },
  {
    ...
    type: 'community',
    category: 'purple',
    name: 'Emergency Debate',
    educationalContent:
      'Community organizations question whether surveillance measures introduced during emergencies should remain active once the crisis has passed. Residents advocate for periodic reviews and clear limits on temporary monitoring programs.',
    effect: '',
    effectType: 'none',
    isPowerUp: false,
  },
  {
    ...
    type: 'community',
    category: 'purple',
    name: 'Camera Repositioning',
    educationalContent:
      'Neighbors work together to encourage responsible camera placement, adjusting angles to reduce unnecessary recording of sidewalks, neighboring homes, and other shared spaces while still addressing safety concerns.',
    effect: '',
    effectType: 'none',
    isPowerUp: false,
  },
  // ── Neighborhood Power-Up cards (gameplay effects) ──
  {
    id: 'purple-07',
    type: 'community',
    category: 'purple',
    name: 'Block by Block',
    educationalContent:
      'Organizing one block at a time builds the dense, trusting networks that make a neighborhood hard to surveil and easy to mobilize.',
    effect: 'Each player immediately draws 1 Community Card.',
    effectType: 'draw-cards-all',
    effectValue: 1,
    isPowerUp: true,
  },
  {
    ...
    type: 'community',
    category: 'purple',
    name: 'Neighbor Support',
    educationalContent:
      'Mutual-aid networks are critical infrastructure: neighbors showing up for one another is one of the most resilient defenses against surveillance-driven isolation.',
    effect: 'Move any one player to your space for free.',
